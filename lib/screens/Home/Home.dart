        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // 2. Search Section
              SizedBox(child: const SearchScreen()),
              const SizedBox(height: 20),
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    Categories(imgPath: 'assets/img/shorts.png', title: 'Shorts', pageLink: const CategoriesPage()),
                    const SizedBox(width: 20),
                    Categories(imgPath: 'assets/img/shoe.png', title: 'Shoes', pageLink: const CategoriesPage()),
                    const SizedBox(width: 20),
                    Categories(imgPath: 'assets/img/bag.png', title: 'Bag', pageLink: const CategoriesPage()),
                    const SizedBox(width: 20),
                    Categories(imgPath: 'assets/img/Accessories.png', title: 'Accessory', pageLink: const CategoriesPage()),
                  ],
                ),
              ),
